...
$(document).ready(function () {
  ...
  __webpack_require__(/*! ./blocks/reviews */ "./src/js/blocks/reviews.js");
  __webpack_require__(/*! ./blocks/grey-block */ "./src/js/blocks/grey-block.js");
  ...
  (function initOurTeamAnimation() {
    var controller = new scrollmagic_scrollmagic_uncompressed_ScrollMagic__WEBPACK_IMPORTED_MODULE_1___default.a.Controller();
    var tween = new TimelineMax().to('.team-list__item_1', 1.5, {
...
function validationForm(formInit) {
  ...
  $(formInit).validate({
    ...
    submitHandler: function submitHandler(form) {
      var currentPhone = $('.user-phone').val();
      $.ajax({
